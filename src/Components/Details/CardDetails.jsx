...
const CardDetails = () => {
    ...
    const { name, image, species, gender, origin, status, type } = characters.find((character) => `${character.id}` === `${id}`);

    return (
        <>

            <iframe src="https://www.youtube.com/embed/6vAxc0Av_UI?&autoplay=1&loop=1&mute=1&showinfo=0&controls=0"></iframe>
